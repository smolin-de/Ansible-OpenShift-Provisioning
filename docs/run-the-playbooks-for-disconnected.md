...
* `oc-mirror` is used as default although it is possible to switch to using the legacy way of mirroring platform separately as well. **NOTE**: Only legacy way supports specifying your own org on the registry for the ocp images.
